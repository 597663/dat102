...
public final class MaksHaug<T extends Comparable<? super T>> implements MaksHaugInterface<T> {
	...
	/*
	 * Vi har et undertre med rot i posisjon node. Undertreet er en haug bortsett
	 * fra roten at roten kanskje ikke oppyller kravet om å være større enn barna
	 * sine. Metoden reparer undertreet slik at undertreet er en haug etter at
	 * metoden er utført.
	 */
